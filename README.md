...
- Link:  
  `https://heibox.uni-heidelberg.de/f/194430ba907f4eea89f6/`
...
- **Customizable Term List:**  
  Open the "Manage Redaction Terms" window to add, edit, or delete sensitive terms. This allows you to add project-specific identifiers or institution names.

- **Built-in Terms:**  
  Includes a default, multi-language list of common sensitive terms in English, German, and French.
...
1. Launch the application by double-clicking the `Clinical_Anonymizer.exe` file.  
2. Click **"Browse"** next to **"Source PDF Document"** to select your file.  
3. The **"Destination Folder"** and **"Output Filename"** will be set automatically. You can change them if needed.  
4. Select **"Standard Protection"** or **"Enhanced Protection"**.  
5. (Optional) Click **"Manage Redaction Terms"** to review or add to the list of terms that will be redacted.  
6. Click the **"Execute Anonymization"** button.  
7. A progress bar will show the status. When finished, you will be asked if you want to open the output folder.
